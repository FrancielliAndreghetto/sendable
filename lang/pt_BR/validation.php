...
return [
    ...
    | classe validadora. Algumas regras possuem múltiplas versões,
    | como as regras de tamanho. Fique à vontade para ajustar cada uma delas aqui.
    |
    */
    ...
    'ascii' => 'O campo :attribute deve conter somente caracteres alfanuméricos e símbolos de byte único.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Linhas de validação customizadas
    |--------------------------------------------------------------------------
    |
    | Aqui você pode especificar mensagens de validação customizadas para atributos
    | usando a convenção "atributo.regra" para nomear as linhas. Isso facilita
    | especificar mensagens customizadas para regras específicas.
    |
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Atributos customizados para validação
    |--------------------------------------------------------------------------
    |
    | As seguintes linhas são usadas para substituir o placeholder do atributo
    | por algo mais legível, como "Endereço de E-Mail" em vez de "email".
    | Isso ajuda a tornar a mensagem mais clara para o usuário.
    |
    */
